...
async function loadRole(){
  ...
  try{
    ...
    // If we can't read /users/{uid}, the app cannot decide admin/mechanic.
    // To avoid a blank screen when the user is already signed-in, force sign-out.
    try{
      alert(
        "Accès refusé à votre profil utilisateur (Firestore).\n\n"+
        "Vérifie les règles Firestore et que users/"+currentUid+" existe.\n\n"+
